            ...
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="w-full max-w-[640px] mb-2 px-2">
                    <div className="mb-4">
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbSeparator />
                                <BreadcrumbItem>
                                    <BreadcrumbPage className="font-semibold text-foreground text-sm">สุ่มตัว X</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-4 pb-4 border-b border-border/40">
                        <h1 className="text-3xl font-bold tracking-tight text-foreground">สุ่มตัว X</h1>
